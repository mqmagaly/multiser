...
<body class="container">
        ...
        <form action="{{route('criarMaquina')}}" method="POST" class="container">
        @csrf
            <!-- <form class="row g-3 needs-validation" action="upload.php" method="POST" enctype="multipart/form-data" novalidate> -->
                <fieldset class="row g-3 needs-validation">
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="marca" value="{{ old('marca') }}">
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="modelo" value="{{ old('modelo') }}">
                        <div class="valid-tooltip">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-2 position-relative">
                        ...
                        <input type="number" class="form-control" id="validationTooltip01" name="ano" value="{{ old('ano') }}">
                        @error('ano')
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="chasis" value="{{ old('chasis') }}">
                        <div class="valid-tooltip">
                            Looks good!
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="titular" value="{{ old('titular') }}">
                        <div class="valid-tooltip">
                            Looks good!
                        </div>
                    </div>
